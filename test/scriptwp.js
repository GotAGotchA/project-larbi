...
function delayedFunction(){
    ...
    var imgL = document.getElementById("LeftIdImage");
    var imgC= document.getElementById("CenterIdImage");
    var imgR = document.getElementById("RightIdImage");

    document.getElementById("lefttitle").innerHTML = courses[rL].title;
    document.getElementById("price").innerHTML = '$' + courses[rL].price;
    
    document.getElementById("centertitle").innerHTML = courses[rM].title;
    document.getElementById("price2").innerHTML = '$' + courses[rM].price;

    document.getElementById("righttitle").innerHTML= courses[rR].title;
    document.getElementById("price3").innerHTML= '$' + courses[rR].price;
    imgL.src = courses[rL].image;
    imgC.src = courses[rM].image;
